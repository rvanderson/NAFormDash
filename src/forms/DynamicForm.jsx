            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-gray-600 text-sm @sm:text-base max-w-md truncate">
              ...
              <div className="flex items-center gap-2">
                ...
                <button 
                  onClick={() => navigate(`/forms/${formId}/edit-content?returnTo=${encodeURIComponent(location.pathname)}`)}
                ...
                <button 
                  onClick={() => navigate(`/?edit=${formId}&returnTo=${encodeURIComponent(location.pathname)}`)}

          ...
          {formConfig && (
            <div className="mb-8 p-6 bg-gradient-to-r from-purple-50 to-blue-50 border border-purple-200 rounded-xl">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">AI-Generated Form</h3>
                  <p className="text-sm text-gray-600 leading-relaxed">
                    This form was automatically created by AI on {new Date(formConfig.createdAt).toLocaleDateString('en-US', {
                      year: 'numeric',
                      month: 'long',
                      day: 'numeric'
                    })}.
